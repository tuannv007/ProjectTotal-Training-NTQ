...
public class KeyParam {
    ...
    public static final String KeyApiBirthDay = "bir";
    public static final String KeyApiInterIn = "inters_in";
    public static final String KeyApiDeviceID = "device_id";
    public static final String KeyApiNotifyToken = "notify_token";
    public static final String KeyApiDeviceType = "device_type";
    public static final String KeyApiLoginTime = "login_time";
